...
| [HASH_check](Scripts/HASH_check/HASH_check.ps1) | Analysis | Автоматизированний поиск хэшей файлов (Расположенных в папке "HASH_check" рядом со скриптом) в сети (VirusTotal, OpenTip) через API |
